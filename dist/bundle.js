...
(() => {
  ...
  var e = {
      564: (e, t, n) => {
        ...
        o.push([
          e.id,
          '.buttonsLine{width:100%;display:flex;justify-content:center}.button{width:95px;height:50px;margin:5px;margin-top:10px;border:none;border-radius:10px;box-shadow:0px 3px 0px 0px #a69d91;font-size:28px;background:#e5e4e1;color:#35352c;font-weight:900}',
          '',
        ]);
        const u = o;
      },
      692: (e, t, n) => {
        ...
        o.push([
          e.id,
          '.calculatorKeys{width:95%;margin:15px;padding:20px;border-radius:10px;background:#d1cccc;display:inline-block}.endButton{width:188px;height:55px;margin:5px;border-radius:10px;padding-top:5px;border:none;color:#fff;text-align:center;font-size:18px;font-family:"Spartan",sans-serif}.Reset{background:#377f86;box-shadow:0px 3px 0px 0px #1b5f65}.EqualSign{background:#ca5502;box-shadow:0px 3px 0px 0px #893901}',
          '',
        ]);
        const u = o;
      },
      861: (e, t, n) => {
        ...
        o.push([
          e.id,
          '*{box-sizing:border-box;margin:0;padding:0}body{background:#e6e6e6;display:flex;justify-content:center;font-family:"Spartan",sans-serif}.calcContain{width:500px;min-height:600px;margin-top:10%;padding:20px;position:relative}@media(min-width: 350px){.calcContain{width:370px;display:flex;flex-direction:column;align-items:center}.title{text-align:start}.screen{width:310px}.endButton{width:126px}}',
          '',
        ]);
        const u = o;
      },
      885: (e, t, n) => {
        ...
        o.push([
          e.id,
          '.header{margin-top:15px}.title{margin-left:10px}.screen{position:relative;width:95%;height:80px;margin:0 auto 0 auto;margin-top:25px;padding:10px;border-radius:10px;font-size:32px;text-align:end;background:#ededed;color:#000;font-weight:900}.p{width:95%}.p2{position:absolute;bottom:10px;right:30px}',
          '',
        ]);
        const u = o;
      },
      ...
      448: (e, t, n) => {
        ...
        function rr() {
          Kn && (Kn.detachEvent('onpropertychange', lr), (Zn = Kn = null));
        }
        function lr(e) {
          if ('value' === e.propertyName && Xn(Zn)) {
            var t = [];
            if ((qn(t, Zn, e, Ce(e)), (e = Yn), Fe)) e(t);
            else {
              Fe = !0;
              try {
                Oe(e, t);
        ...
        function ar(e, t, n) {
          'focusin' === e
            ? (rr(), (Zn = n), (Kn = t).attachEvent('onpropertychange', lr))
            : 'focusout' === e && rr();
        }
        function or(e) {
        ...
        function Kl() {
          if (!jl && null !== Ul) {
            ...
            try {
              ...
              throw (null !== Ul && (Ul = Ul.slice(e + 1)), Cl(Ll, ql), t);
            } finally {
              jl = !1;
            }
          }
        ...
        function xa(e) {
          ...
          function c(e, t, n, r) {
            return null !== t && t.elementType === n.type
              ...
              : (((r = Wi(n.type, n.key, n.props, null, e.mode, r)).ref = Ea(
                  e,
                  t,
                  n
                )),
          ...
          function d(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case E:
                  return (
                    ((n = Wi(t.type, t.key, t.props, null, e.mode, n)).ref = Ea(
                      e,
                      null,
                      t
                    )),
          ...
          function v(l, u, i, c) {
            ...
            for (
              var f = (s = null), h = u, v = (u = 0), g = null, y = i.next();
              null !== h && !y.done;
              v++, y = i.next()
            ) {
        ...
        function Oa(e, t) {
          switch ((sl(za, t), sl(Ta, e), sl(Pa, Na), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function ao(e, t, n, r, l, a) {
          if (
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (Za.current = null === e || null === e.memoizedState ? Oo : Mo),
            (e = n(r, l)),
            no)
          ) {
            a = 0;
        ...
        var Lo = {
          ...
          Oo = {
            ...
            useOpaqueIdentifier: function () {
              ...
              return ho((t = 'r:' + (Zr++).toString(36))), t;
            },
            unstable_isNewReconciler: !1,
          },
          Mo = {
        ...
        function Wo(e, t, n, r, l) {
          ...
          if ((la(t, l), null === t.stateNode))
            ...
            u !== f || d !== m || pl.current || oa
              ? ('function' == typeof p &&
                  (ha(t, n, p, r), (m = t.memoizedState)),
                (c = oa || ga(t, n, c, r, d, m, i))
                  ? (s ||
        ...
        function au(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((Ma(), cl(pl), cl(dl), Ka(), 0 != (64 & (t = e.flags))))
                throw Error(o(285));
        ...
        function Su(e, t) {
          switch (t.tag) {
            ...
            case 13:
              return (
                null !== t.memoizedState && ((Bu = Bl()), hu(t.child, !0)),
                void xu(t)
              );
            case 19:
              return void xu(t);
        ...
        function fi(e, t, n) {
          ...
          Bt(e, t, n), e === zu && ((Au |= t), 4 === Iu && hi(e, Ou));
          var r = $l();
          1 === t
            ? 0 != (8 & Tu) && 0 == (48 & Tu)
              ? vi(e)
        ...
        function pi(e, t) {
          ...
          if (((r = Dt(e, e === zu ? Ou : 0)), (t = It), 0 === r))
            ...
            15 === t
              ? ((n = vi.bind(null, e)),
                null === Ul ? ((Ul = [n]), (Al = Cl(Ll, Kl))) : Ul.push(n),
                (n = Fl))
              : 14 === t
        ...
        function mi(e) {
          ...
          if (
            ...
            if (
              ...
              throw ((t = Fu), ki(e, 0), hi(e, n), pi(e, Bl()), t);
            switch (
              ...
              case 3:
                if (
                  (hi(e, n), (62914560 & n) === n && 10 < (r = Bu + 500 - Bl()))
                ) {
                  if (0 !== Dt(e, 0)) break;
          ...
          return pi(e, Bl()), e.callbackNode === t ? mi.bind(null, e) : null;
        }
        function hi(e, t) {
          for (
            t &= ~ju,
        ...
        function vi(e) {
          ...
          if (
            ...
            throw ((n = Fu), ki(e, 0), hi(e, t), pi(e, Bl()), n);
          return (
        ...
        function xi(e, t) {
          ...
          if ((ta(), (Tu = n), (Nu.current = r), null !== Lu))
            throw Error(o(261));
        ...
        function Ii() {
          if (null === Xu) return !1;
          var e = Xu;
          if (((Xu = null), 0 != (48 & Tu))) throw Error(o(331));
          var t = Tu;
          Tu |= 32;
          var n = ei;
          ei = [];
        ...
        function r(e, r) {
          for (var a = {}, o = [], u = 0; u < e.length; u++) {
            ...
            if (-1 !== d) t[d].references++, t[d].updater(p);
              ...
              var m = l(p, r);
              (r.byIndex = u),
                t.splice(u, 0, { identifier: f, updater: m, references: 1 });
            }
            o.push(f);
          }
          return o;
    ...
    (() => {
      ...
      var b = function () {
          ...
          return e.createElement(
            'div',
            { className: 'header' },
            e.createElement('h2', { className: 'title' }, 'Calculator Project'),
            e.createElement(
              'div',
              { className: 'screen' },
              e.createElement(
                'div',
                { className: 'p p1 mathOperation' },
                n,
                ' ',
                r
              )
      ...
      var E = function (t) {
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              {
                onClick: function () {
                  ' % ' == a && console.log('Precionaste la tecla modulo '),
                    ' + ' == a &&
